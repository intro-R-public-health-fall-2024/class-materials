...
**As further work, we could think about extending our function to allow for inputs that are vectors instead of individual values, but we won't do that here!**
